...
(function () {
  ...
  const dict = {
    ko: {
      meta: {
        title: "SparkClaw — AI 네이티브 1인 창업자 프로그램",
      ...
      hero: {
        ...
        sub: "SparkClaw는 에이전틱 AI 시대의 1인 및 소규모 팀 창업가를 위한 스파크랩의 첫 프로그램입니다.",
      ...
      philosophy: {
        ...
        body: {
          p1: "기획과 개발, 마케팅, 고객 대응까지 AI 에이전트가 담당하는 시대입니다. SparkClaw는 AI를 ‘도구’가 아닌 ‘팀원’으로 활용하는 창업가를 발굴합니다.",
          p2: "SparkClaw는 AI 네이티브 창업가 한 명 한 명에 투자하는 데서 멈추지 않습니다. 이들을 한 자리에 모아 국내에서 가장 강력한 <em class=\"accent\">AI 창업자 커뮤니티</em>를 만들어갑니다. 1인 창업가에게는 동료가 곧 가장 강력한 레버리지이기 때문입니다."
        },
        quote2: {
      ...
      benefits: {
        ...
        sub: "SparkClaw 참여 기업의 성장을 지원하기 위해 파트너사와 함께 AI 기업 맞춤형 크레딧 혜택을 제공합니다.",
        items: [
        ...
        partner: {
          title: "SparkClaw 파트너로 합류하고 싶으신가요?",
      ...
      process: {
        ...
        sub: "이번 심사에서 투자로 이어지지 않아도, SparkClaw 커뮤니티와의 인연은 이어집니다.",
        steps: [
          { title: "온라인 지원",    desc: "홈페이지 상단의 지원서 양식을 작성하여 제출." },
          { title: "서류 스크리닝",  desc: "학력 및 경력 무관, AI를 ‘팀원’처럼 운용한 방식을 중심으로 평가." },
          { title: "집중 부트캠프",  desc: "SparkClaw 크레딧 제공, 스파크랩 파트너들과 함께하는 몰입형 부트캠프 진행." },
      ...
      about: {
        ...
        body: {
          ...
          p2: "이제 스파크랩은 SparkClaw를 통해 국내 AI 분야의 우수 창업자를 선제 발굴, 육성하고자 합니다."
        },
        quote: {
          text: "“에이전틱 AI 시대에는 뛰어난 창업가 한 명이 AI 팀과 함께 시장을 바꿀 수 있습니다. SparkClaw는 그런 창업가들을 가장 먼저, 가장 깊이 이해하기 위한 프로그램입니다.”",
          cite: "김유진 · 스파크랩 대표"
        },
        facts: [
      ...
      news: {
        ...
        title: "언론이 주목한 SparkClaw",
        sub: "국내 주요 매체가 다룬 SparkClaw 관련 소식을 만나보세요.",
        cta: "기사 읽기 →",
        loading: "기사 불러오는 중…",
        publishers: {
          "donga.com": "동아일보",
      ...
      insights: {
        label: "06 — Insights",
        title: "SparkClaw Insight",
        sub: "AI 네이티브 창업자를 위한 조언.",
        stamp: "SparkClaw Insights"
      },
      faq: {
        label: "07 — FAQ",
        title: "자주 묻는 질문",
        items: [
          { q: "공동창업자 없이도 정말 지원할 수 있나요?",
            a: "네, SparkClaw는 1인 창업가 혹은 소규모 팀을 위한 프로그램입니다. 팀이 없다는 것은 결격 사유가 아니라 프로그램의 전제입니다. AI 에이전트를 팀원처럼 설계하고 운용한 기록이 가장 중요한 평가 지표입니다." },
          ...
          { q: "온라인 중심인가요, 오프라인 모임도 있나요?",
            a: "SparkClaw 프로그램은 온라인/오프라인의 다양한 워크샵과 강의 및 세션으로 이루어져 있습니다. 또한, AI 창업가 커뮤니티 형성을 위한 정기 오프라인 밋업을 진행할 예정입니다." },
          { q: "해외 창업가도 지원할 수 있나요?",
          ...
          { q: "SparkClaw에서 제공되는 AI 크레딧은 언제 제공되나요?",
      ...
      timeline: {
        ...
        title: "Cohort 01 일정",
        sub: "SparkClaw 1기의 주요 일정을 안내합니다.",
        items: [
    ...
    en: {
      meta: {
        title: "SparkClaw — An accelerator for AI-native solo founders",
      ...
      hero: {
        ...
        sub: "SparkClaw is SparkLabs' first program built for solo founders and small teams in the age of Agentic AI.",
      ...
      philosophy: {
        ...
        body: {
          p1: "Agentic AI now ships product, writes code, runs marketing, and handles customer ops. SparkClaw backs founders who treat AI not as a tool, but as a teammate.",
          p2: "SparkClaw doesn't stop at backing AI-native founders one by one. We bring them together to build <em class=\"accent\">Korea's strongest community of AI-native founders</em> — because for a solo operator, peers are the most powerful form of leverage."
        },
        quote2: {
      ...
      benefits: {
        ...
        sub: "Supporting the growth of SparkClaw companies — we offer tailored AI infrastructure credits in partnership with global leaders.",
        items: [
      ...
      process: {
        ...
        sub: "Not funded this round? Your relationship with the SparkClaw community doesn't end there.",
        steps: [
          ...
          { title: "Intensive bootcamp", desc: "SparkClaw credits provided. A focused bootcamp alongside SparkLabs partners." },
      ...
      about: {
        ...
        body: {
          ...
          p2: "Now, with SparkClaw, SparkLabs is going earlier — discovering and building Korea's strongest AI-native founders ahead of the rest of the market."
        },
        quote: {
          text: "“In the age of Agentic AI, a single outstanding founder can change a market alongside an AI team. SparkClaw exists to understand those founders — earlier and more deeply than anyone else.”",
      ...
      news: {
        label: "05 — In the News",
        title: "SparkClaw in the press",
        sub: "What Korea's leading outlets are saying about SparkClaw.",
        cta: "Read article →",
      ...
      faq: {
        ...
        items: [
          { q: "Can I really apply without a co-founder?",
            a: "Yes. SparkClaw is built for solo founders and small teams. Having no traditional team isn't a gap — it's the premise. What we evaluate most closely is how you've designed and orchestrated AI agents as teammates." },
          ...
          { q: "Is the program fully online?",
            a: "SparkClaw runs through a mix of online and offline workshops, lectures, and sessions. We also host regular offline meetups to build a working community of AI founders." },
          ...
          { q: "When are the AI credits provided by SparkClaw distributed?",
      ...
      timeline: {
        ...
        sub: "Key dates for SparkClaw's inaugural cohort.",
        items: [
          ...
          { date: "Early Aug – Early Oct", title: "Bootcamp Program", desc: "Intensive bootcamp with SparkClaw credits provided" },
  ...
  const newsItems = [
    ...
    },
    {
      ...
      title: {
        ...
        en: "SparkLabs launches ‘SparkClaw,’ an accelerator for solo AI-native founders"
      },
  ...
  function renderInsights(lang) {
    ...
    if (!grid) return;
    const data = dict[lang] || dict.ko;
    const stampText = (data.insights && data.insights.stamp) || "SparkClaw Insights";
